namespace ProiectFinal.Migrations
{
    ...
    public partial class init : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        ProdName = c.String(nullable: false, maxLength: 100),
                        ...
                        ProdRating = c.Double(nullable: false),
                    })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Comments", "ProdId", "dbo.Products");
            ...
            DropIndex("dbo.Comments", new[] { "ProdId" });
